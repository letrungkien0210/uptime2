...
// configure mongodb
// console.log('mongodb://' + config.mongodb.server +':27017/' + config.mongodb.database);
mongoose.connect(config.mongodb.connectionString || 'mongodb://' + config.mongodb.server +':27017/' + config.mongodb.database);
